...
export class GraphConfigBuilder<NodeData = unknown, EdgeData = unknown, PortData = unknown> {
  ...
  private constructor() {
    ...
    const defaultClipboard = new DefaultClipboard<NodeData, EdgeData, PortData>(storage);
    this.draft = {
      getNodeConfig: () => rect,
      getEdgeConfig: () => line,
  ...
  public registerNode(
    getConfig: (node: ICanvasNode<NodeData, PortData>) => INodeConfig<ICanvasNode<NodeData, PortData>> | undefined,
  ): this {
    this.draft.getNodeConfig = getConfig;
    return this;
  }

  public registerEdge(getConfig: (edge: ICanvasEdge<EdgeData>) => IEdgeConfig<EdgeData> | undefined): this {
    this.draft.getEdgeConfig = getConfig;
    return this;
  }

  public registerPort(
    getConfig: (port: ICanvasPort<PortData>) => IPortConfig<NodeData, EdgeData, PortData> | undefined,
  ): this {
    this.draft.getPortConfig = getConfig;
    return this;
  }

  public registerGroup(getConfig: (group: ICanvasGroup) => IGroupConfig | undefined): this {
    this.draft.getGroupConfig = getConfig;
    return this;
  }

  public registerClipboard(getClipboard: () => IGraphClipboard<NodeData, EdgeData, PortData>): this {
