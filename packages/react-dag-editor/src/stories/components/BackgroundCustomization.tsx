...
import { Graph, GraphModel, GridBackground, ReactDagEditor, useBackgroundRect, useGraphReducer } from "../../";
...
export const BackgroundCustomization: React.FC = () => {
  ...
  return (
    <ReactDagEditor style={{ width: "900px", height: "600px" }} state={state} dispatch={dispatch}>
      <Graph
        background={
          <GridBackground rect={rect} smallGridAttributes={{ stroke: "green" }} gridAttributes={{ stroke: "yellow" }} />
        }
      />
    </ReactDagEditor>
  );
