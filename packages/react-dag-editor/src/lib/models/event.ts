...
import type { EdgeModel, ICanvasEdge } from "./edge";
import type { IContainerRect, IPoint, Direction } from "./geometry";
import type { ICanvasNode, NodeModel } from "./node";
...
export interface ICanvasUpdateDataEvent {
  ...
  updater(prevData: ContentState): ContentState;
}
...
export interface IEdgeConnectEndEvent
  ...
  isCancel: boolean;
  edgeWillAdd:
    | ((edge: ICanvasEdge, data: ContentState) => ICanvasEdge)
    | undefined;
}
