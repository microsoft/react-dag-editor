import { InMemoryClipboard, InMemoryStorage } from "../built-in";
import { IEdgeConfig, IGroupConfig, INodeConfig, IPortConfig } from "../models/settings";
...
export class GraphConfigBuilder<NodeData = unknown, EdgeData = unknown, PortData = unknown> {
  ...
  public static default(): GraphConfigBuilder {
    return new GraphConfigBuilder(
      ...
      new Map(),
      new Map(),
      new InMemoryClipboard(new InMemoryStorage())
    );
  }
